...
// IBM Bluemix Info
char orgName[] = "mm9i0c";      // Your org name, found under the "Credentials" area in your Bluemix dashboard.
byte mac[] = { 0x00, 0xFF, 0xBB, 0xCC, 0xDE, 0x02 };

char server[] = "mm9i0c.messaging.internetofthings.ibmcloud.com"; // MQTT Host (taken from Bluemix dashboard)
char type[] = "Arduino";    // Type of device you have registered in the IBM Bluemix Devices area.
char token[] = "2fIaoQdj-l(XlFdahD"; // Token issued when you first register your IoT device (only appears once)
int port = 1883;
